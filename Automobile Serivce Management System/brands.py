...
print("\n" * 2)
text = pyfiglet.print_figlet(text = "LOCKHEED MARTIN", colors = "GREY", width = 100)
print("\n" * 2)
...
print("\n" * 2)
text = pyfiglet.print_figlet(text = "FORD", colours = "WHITE", width = 100)
print("\n" * 2)
text = pyfiglet.print_figlet(text = "NISSAN", colours = "BLUE", width = 100)
print("\n" * 2)
text = pyfiglet.print_figlet(text = "PORSCHE", colours = "RED", width = 100)
print("\n" * 2)
text = pyfiglet.print_figlet(text = "GENERAL DYNAMICS", colours = "RED", width = 100)
print("\n", "\a" * 2)
